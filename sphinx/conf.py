...
# -*- coding: utf-8 -*-
#
# advent-of-code-2021 documentation build configuration file, created by
# sphinx-quickstart.
#
...
copyright = 'Ben Simms <ben@bensimms.moe>'
...
latex_documents = [
    (master_doc, 'advent-of-code-2021.tex', 'advent-of-code-2021 Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'advent-of-code-2021', 'advent-of-code-2021 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'advent-of-code-2021', 'advent-of-code-2021 Documentation',
     author, 'advent-of-code-2021', 'One line description of project.',
     'Miscellaneous'),
]
