...
If :code:`advent-of-code-2021` is available in your opam repository, you can just call::

  opam install advent-of-code-2021

Build and install with :code:`dune`
-----------------------------------

Checkout the sources of :code:`advent-of-code-2021` in a directory.
